    ...
    <div class="container" >
      <div class="row justify-content-center">
        <div class="login-container" style="background: url('/images/background/login-container.jpg'), ;">
          <form action="/login" method="post" class="login-form" @submit.prevent="submitForm">
            <input type="text" class="form-control" v-model="username" placeholder="아이디" required>
            ...
            <div class="center-align">
              <div class="form-check" style="display: inline-block; margin-top: 10px; padding-right: 20px">
                <input style="height: 18px; position: relative; bottom: 6px;" type="checkbox" class="form-check-input" id="saveId" v-model="saveId">
                <label class="form-check-label" for="saveId">아이디 저장</label>
              </div>
              <div class="form-check" style="display: inline-block; margin-top: 10px;">
                <input style="height: 18px; position: relative; bottom: 6px;" type="checkbox" class="form-check-input" id="keepLoggedInBtn" v-model="keepLoggedIn">
                <label class="form-check-label" for="keepLoggedInBtn">로그인 상태 유지</label>
              </div>
            </div>
            <div class="social-login">
              <a href="/oauth2/authorization/kakao" class="social-login-button kakao"><img class="social-logo" src="/images/kakaoIco.png" alt="Kakao login"></a>
              <a href="/oauth2/authorization/naver" class="social-login-button naver"><img class="social-logo" src="/images/naverIco.png" alt="Naver login"></a>
            </div>
            <hr>
            <div class="center-align">
              <a href="/register" class="login-form-link">아이디 찾기</a>
